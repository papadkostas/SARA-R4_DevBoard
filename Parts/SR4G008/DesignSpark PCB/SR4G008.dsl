...
(library Library_1
	...
	(patternDef "SR4G008" (originalName "SR4G008")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.346, 0.025) (textStyleRef "Default") (isVisible True))
		)
		...
		(layerContents (layerNumRef 18)
			(arc (pt -2.788, -3.541) (radius 0.08855) (startAngle 0.0) (sweepAngle 0.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -2.788, -3.541) (radius 0.08855) (startAngle 180.0) (sweepAngle 180.0) (width 0.2))
		)
	)
	...
	(compDef "SR4G008" (originalName "SR4G008") (compHeader (numPins 6) (numParts 1) (refDesPrefix ANT)
		...
		(compPin "2" (pinName "FEED") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://componentsearchengine.com/Datasheets/1/SR4G008.pdf")
	)
